...
public class TowerCarrierPlatformPolicyRule {
  ...
  public boolean equals(Object o) {
    ...
    return getActive() == that.getActive() && getTowerName().equals(that.getTowerName()) && getCarrierName().equals(that.getCarrierName()) && getPlatformName().equals(that.getPlatformName());
  }
  ...
  public String toString() {
    return "TowerCarrierPlatformPolicyRule{" + "towerName='" + towerName + '\'' + ", carrierName='" + carrierName + '\'' + ", platformName='" + platformName + '\'' + ", active=" + active + '}';
  }
}
