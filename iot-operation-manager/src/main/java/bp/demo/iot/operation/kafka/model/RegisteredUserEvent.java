...
public class RegisteredUserEvent
  ...
  public RegisteredUserEvent(String carrierName, String towerName,
                             String email, UUID userId, Date dob,
                             boolean active, Date timeStamp) {
  ...
  public String toString() {
    return "RegisteredUserEvent{" + "carrierName='" + carrierName + '\'' + "," +
